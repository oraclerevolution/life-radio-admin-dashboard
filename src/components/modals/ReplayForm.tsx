...
import { ReplayPlaylist } from "@/types";
...
export function ReplayForm({ open, onClose, playlists }: ReplayFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      title: "Replay créé",
      description: "Le replay a été créé avec succès."
    });
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Ajouter un replay</DialogTitle>
        </DialogHeader>
